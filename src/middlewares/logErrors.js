...
export const logErrorHandler = function (err, req, res, next) {
  let messageToSend;
  ...
  if (messageToSend) {
    ...
    //       "<br/><br/>" +
    //       (messageToSend.stack ? messageToSend.stack : "") +
    //       "</body></html>"
    //   );
    //   return;
    // }
    ...
    if (req.accepts("json")) {
      ...
      if (messageToSend.stack) responseObject.stack = messageToSend.stack;
